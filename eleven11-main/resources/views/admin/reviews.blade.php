                            ...
                            <form method="GET"
                                ...
                                <div class="btn-list">
                                    ...
                                    <a class="btn btn-icon" style="display: none;" type="button"
                                        href="https://hously.archielite.com/admin/real-estate/reviews"
                        ...
                        <div
                                ...
                                <div class="dropdown d-inline-block">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-submenu">
                                            ...
                                            <div class="dropdown-menu">
                                                <button class="dropdown-item bulk-change-item"
                                                    data-key="status"
                                                    data-class-item="Botble\RealEstate\Tables\ReviewTable"
                                        ...
                                        <a class="dropdown-item"
                                            ...
                                            data-method="POST"
                                            data-table-target="Botble\RealEstate\Tables\ReviewTable"
                            ...
                            <div class="d-flex align-items-center gap-1">
                                ...
                                <button class="btn" type="button" data-bb-toggle="dt-buttons"
                                    ...
                                    aria-controls="botble-real-estate-tables-review-table">
                                    <svg class="icon icon-left" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                    ...
                    <div class="card-table">
                        <div class="table-responsive table-has-actions table-has-filter">
                            <table class="table card-table table-vcenter table-striped table-hover"
                                id="botble-real-estate-tables-review-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th title="Author" class="text-start  column-key-1">Author</th>
                                        <th title="Reviewable" class="text-start  column-key-2">Reviewable
                                        </th>
                                        <th title="Star" class=" column-key-3">Star</th>
                                        <th title="Content" class=" column-key-4">Content</th>
