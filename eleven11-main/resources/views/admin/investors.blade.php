                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">Investors</h1>
                                </li>
                            </ol>
                        </nav>
                            ...
                            <form method="GET" action="admin/real-estate/investors"
                                ...
                                <div class="btn-list">
                                    ...
                                    <a class="btn btn-icon" style="display: none;" type="button"
                                        href="admin/real-estate/investors"
                ...
                <div class="card has-actions has-filter">
                    <div class="card-header">
                        <div class="w-100 gap-2 d-block d-md-flex align-items-start justify-content-between flex-wrap">
                                ...
                                <div class="dropdown d-inline-block mb-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-submenu">
                                            ...
                                            <div class="dropdown-menu">
                                                <button class="dropdown-item bulk-change-item" data-key="name"
                                                    data-class-item="Botble\RealEstate\Tables\InvestorTable"
                                        ...
                                        <a class="dropdown-item"
                                            ...
                                            data-table-target="Botble\RealEstate\Tables\InvestorTable"
                            ...
                            <div class="d-block d-md-flex gap-2 mb-1">
                                <a href="/admin/investors/create" class="mb-1 btn action-item btn-primary" tabindex="0"
                                    aria-controls="botble-real-estate-tables-investor-table" type="button"
                                    aria-haspopup="dialog" aria-expanded="false">
                                    <span data-action="create"
                                        data-href="/admin/investors/create"><svg
                    ...
                    <div class="card-table">
                        <div class="table-responsive table-has-actions table-has-filter">
                            <div id="botble-real-estate-tables-investor-table_wrapper"
                                class="dataTables_wrapper dt-bootstrap5 no-footer">
                                {{-- <div id="botble-real-estate-tables-investor-table_filter" class="dataTables_filter">
                                    <label><input type="search" class="form-control form-control-sm"
                                            placeholder="Search..."
                                            aria-controls="botble-real-estate-tables-investor-table"></label>
                                </div> --}}
                                <div class="dt-buttons btn-group w-100 w-sm-auto"> 
                                    {{-- <button
                                        class="btn action-item btn-primary" tabindex="0"
                                        aria-controls="botble-real-estate-tables-investor-table"
                                        type="button"><span><span data-action="create"
                                                data-href="admin/real-estate/investors/create"><svg
                                                    class="icon" xmlns="http://www.w3.org/2000/svg" width="24"
                                            ...
                                            {{-- <button class="btn buttons-reload" tabindex="0"
                                        aria-controls="botble-real-estate-tables-investor-table" type="button"><span>
                                ...
                                <div id="botble-real-estate-tables-investor-table_processing"
                                ...
                                <table
                                    ...
                                    id="botble-real-estate-tables-investor-table"
                                    aria-describedby="botble-real-estate-tables-investor-table_info">
                                    <thead>
                                        <tr>
                                            ...
                                            <th title="Status" width="100"
                                                class="text-center column-key-3 sorting" tabindex="0"
                                                aria-controls="botble-real-estate-tables-investor-table"
                                                rowspan="1" colspan="1" style="width: 100px;"
                                    ...
                                    <tbody>
                                        <tr class="odd">
                                            ...
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/investors/edit/14"
                                                    title="Rest Super">Rest Super</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                            ...
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/14?ref_lang=vi"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/14?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/investors/14"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                13</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/investors/edit/13"
                                                    title="Shinkong">Shinkong</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/13?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/13?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/investors/13"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                12</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/investors/edit/12"
                                                    title="State Super">State Super</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/12?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/12?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/investors/12"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                11</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/investors/edit/11"
                                                    title="New Jersey Division of Investment">New Jersey
                                                    Division of Investment</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/11?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/11?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/investors/11"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                10</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/investors/edit/10"
                                                    title="New York City ERS">New York City ERS</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/10?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/10?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/investors/10"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                9</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/investors/edit/9"
                                                    title="BT Group">BT Group</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/9?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/9?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/investors/9"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                8</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/investors/edit/8"
                                                    title="HOOPP">HOOPP</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/8?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/8?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/investors/8"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                7</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/investors/edit/7"
                                                    title="MEAG Munich ERGO">MEAG Munich ERGO</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/7?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/7?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/investors/7"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                6</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/investors/edit/6"
                                                    title="PSP Investments">PSP Investments</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/6?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/6?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/investors/6"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                5</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/investors/edit/5"
                                                    title="Government Pension Fund Global">Government
                                                    Pension Fund Global</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/5?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/investors/edit/5?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/investors/5"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                ...
                                <div class="card-footer d-flex flex-column flex-sm-row justify-content-between align-items-center gap-2"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        <div class="dataTables_length"
                                            id="botble-real-estate-tables-investor-table_length">
                                            <label><span class="dt-length-style"><select
                                                        name="botble-real-estate-tables-investor-table_length"
                                                        aria-controls="botble-real-estate-tables-investor-table"
                                        ...
                                        <div class="m-0 text-muted">
                                            <div class="dataTables_info"
                                                id="botble-real-estate-tables-investor-table_info" role="status"
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <div class="dataTables_paginate paging_simple_numbers"
                                            id="botble-real-estate-tables-investor-table_paginate">
                                            <ul class="pagination">
                                                <li class="paginate_button page-item previous disabled"
                                                    id="botble-real-estate-tables-investor-table_previous">
                                                    <a aria-controls="botble-real-estate-tables-investor-table"
                                                ...
                                                <li class="paginate_button page-item next"
                                                    id="botble-real-estate-tables-investor-table_next"><a
                                                        href="#"
                                                        aria-controls="botble-real-estate-tables-investor-table"
