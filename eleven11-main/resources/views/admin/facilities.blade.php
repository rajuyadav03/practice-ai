                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">Facilities</h1>
                                </li>
                            </ol>
                        </nav>
                            ...
                            <form method="GET" action="admin/real-estate/facilities"
                                ...
                                <div class="btn-list">
                                    ...
                                    <a class="btn btn-icon" style="display: none;" type="button"
                                        href="admin/real-estate/facilities"
                ...
                <div class="card has-actions has-filter">
                    <div class="card-header">
                        <div class="w-100 gap-2 d-block d-md-flex align-items-start justify-content-between flex-wrap">
                                ...
                                <div class="dropdown d-inline-block mb-1">
                                    <div class="dropdown-menu">
                                        <div class="dropdown-submenu">
                                            ...
                                            <div class="dropdown-menu">
                                                <button class="dropdown-item bulk-change-item" data-key="name"
                                                    data-class-item="Botble\RealEstate\Tables\FacilityTable"
                                        ...
                                        <a class="dropdown-item"
                                            ...
                                            data-table-target="Botble\RealEstate\Tables\FacilityTable"
                            ...
                            <div class="d-block d-md-flex gap-2 mb-1">
                                <a href="/admin/facilities/create" class="mb-1 btn action-item btn-primary" tabindex="0"
                                    aria-controls="botble-real-estate-tables-facility-table" type="button"
                                    aria-haspopup="dialog" aria-expanded="false">
                                    <span data-action="create"
                                        data-href="/admin/facilities/create"><svg
                    ...
                    <div class="card-table">
                        <div class="table-responsive table-has-actions table-has-filter">
                            <div id="botble-real-estate-tables-facility-table_wrapper"
                                class="dataTables_wrapper dt-bootstrap5 no-footer">
                                <div id="botble-real-estate-tables-facility-table_processing"
                                ...
                                <table
                                    ...
                                    id="botble-real-estate-tables-facility-table"
                                    aria-describedby="botble-real-estate-tables-facility-table_info">
                                    <thead>
                                        <tr>
                                            ...
                                            <th title="ID" width="20"
                                                ...
                                                tabindex="0"
                                                aria-controls="botble-real-estate-tables-facility-table"
                                    ...
                                    <tbody>
                                        <tr class="odd">
                                            ...
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/facilities/edit/12"
                                                    title="Fitness">Fitness</a></td>
                                            ...
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/12?ref_lang=vi"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/12?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/facilities/12"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                11</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/facilities/edit/11"
                                                    title="Bank">Bank</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/11?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/11?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/facilities/11"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                10</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/facilities/edit/10"
                                                    title="Mall">Mall</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/10?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/10?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/facilities/10"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                9</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/facilities/edit/9"
                                                    title="Beach">Beach</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/9?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/9?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/facilities/9"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                8</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/facilities/edit/8"
                                                    title="Bus Stop">Bus Stop</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/8?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/8?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/facilities/8"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                7</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/facilities/edit/7"
                                                    title="Railways">Railways</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/7?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/7?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/facilities/7"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                6</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/facilities/edit/6"
                                                    title="Airport">Airport</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/6?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/6?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/facilities/6"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                5</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/facilities/edit/5"
                                                    title="Pharmacy">Pharmacy</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/5?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/5?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/facilities/5"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                4</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/facilities/edit/4"
                                                    title="Entertainment">Entertainment</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/4?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/4?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/facilities/4"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                3</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="admin/real-estate/facilities/edit/3"
                                                    title="School">School</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/3?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="admin/real-estate/facilities/edit/3?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="admin/real-estate/facilities/3"
                                                        data-dt-single-action="" data-method="DELETE"
                                                        data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                ...
                                <div class="card-footer d-flex flex-column flex-sm-row justify-content-between align-items-center gap-2"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        <div class="dataTables_length"
                                            id="botble-real-estate-tables-facility-table_length">
                                            <label><span class="dt-length-style"><select
                                                        name="botble-real-estate-tables-facility-table_length"
                                                        aria-controls="botble-real-estate-tables-facility-table"
                                        ...
                                        <div class="m-0 text-muted">
                                            <div class="dataTables_info"
                                                id="botble-real-estate-tables-facility-table_info" role="status"
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <div class="dataTables_paginate paging_simple_numbers"
                                            id="botble-real-estate-tables-facility-table_paginate">
                                            <ul class="pagination">
                                                <li class="paginate_button page-item previous disabled"
                                                    id="botble-real-estate-tables-facility-table_previous">
                                                    <a aria-controls="botble-real-estate-tables-facility-table"
                                                ...
                                                <li class="paginate_button page-item next"
                                                    id="botble-real-estate-tables-facility-table_next"><a
                                                        href="#"
                                                        aria-controls="botble-real-estate-tables-facility-table"
