    ...
    <div class="page-wrapper">
        ...
        <div class="page-body page-content">
            <div class="container-xl">
                ...
                <form method="POST" action="/admin/real-estate/categories/create"
                    accept-charset="UTF-8" id="botble-real-estate-forms-category-form" class="js-base-form dirty-check">
                    @csrf
                    <div class="row">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="form-body">
                                        ...
                                        <input type="hidden" name="model" value="Botble\RealEstate\Models\Category">
                                                ...
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <div class="input-group input-group-flat">
                                                        ...
                                                        <span class="input-group-text">
                                                            https://eleven11.com/property-category/
                                                        </span>
