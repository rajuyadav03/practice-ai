                ...
                <div class="card mb-3 table-configuration-wrap" style="display: none;">
                    <div class="card-body">
                        ...
                        <div class="wrapper-filter">
                            ...
                            <form method="GET" action="admin/contacts" accept-charset="UTF-8" class="filter-form">
                                <input type="hidden" name="filter_table_id" class="filter-data-table-id"
                                    value="botble-contact-tables-contact-table">
                                <input type="hidden" name="class" class="filter-data-class"
                                    value="Botble\Contact\Tables\ContactTable">
                                ...
                                <div class="btn-list">
                                    ...
                                    <a class="btn btn-icon" style="display: none;" type="button"
                                        href="admin/contacts" data-bb-toggle="datatable-reset-filter">
                ...
                <div class="card has-actions has-filter">
                    <div class="card-header">
                        <div class="w-100 gap-2 d-block d-md-flex align-items-start justify-content-between flex-wrap">
                                ...
                                <div class="dropdown d-inline-block mb-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-submenu">
                                            ...
                                            <div class="dropdown-menu">
                                                <button class="dropdown-item bulk-change-item" data-key="name"
                                                    data-class-item="Botble\Contact\Tables\ContactTable"
                                                ...
                                                <button class="dropdown-item bulk-change-item" data-key="phone"
                                                    data-class-item="Botble\Contact\Tables\ContactTable"
                                                    data-save-url="admin/tables/bulk-changes/save">
                                        ...
                                        <a class="dropdown-item" href="admin/tables/bulk-actions"
                                            ...
                                            data-table-target="Botble\Contact\Tables\ContactTable"
                            ...
                            <div class="d-block d-md-flex gap-2 mb-1">
                                ...
                                <div class="dropdown">
                                    <button class="btn buttons-collection dropdown-toggle buttons-export"
                                        data-bs-toggle="dropdown" tabindex="0"
                                        aria-controls="botble-contact-tables-contact-table" type="button"
                                    ...
                                    <div class="dropdown-menu">
                                        <button class="dropdown-item" data-bb-toggle="dt-exports"
                                            data-bb-target="csv" aria-controls="botble-contact-tables-contact-table">
                                            <span>
                                                <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24"
                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        ...
                                        <button class="dropdown-item" data-bb-toggle="dt-exports"
                                            ...
                                            aria-controls="botble-contact-tables-contact-table">
                                            <span>
                                                <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24"
                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <div class="card-table">
                        <div class="table-responsive table-has-actions table-has-filter">
                            <div id="botble-contact-tables-contact-table_wrapper"
                                class="dataTables_wrapper dt-bootstrap5 no-footer">
                                <div id="botble-contact-tables-contact-table_filter" class="dataTables_filter">
                                    <label><input type="search" class="form-control form-control-sm"
                                            placeholder="Search..."
                                            aria-controls="botble-contact-tables-contact-table"></label>
                                </div>
                                <div class="dt-buttons btn-group w-100 w-sm-auto">
                                    <div class="btn-group"><button
                                            class="btn buttons-collection dropdown-toggle buttons-export"
                                            tabindex="0" aria-controls="botble-contact-tables-contact-table"
                                            type="button" aria-haspopup="dialog" aria-expanded="false"><span><svg
                                                ...
                                                Export</span></button></div> <button class="btn buttons-reload"
                                        tabindex="0" aria-controls="botble-contact-tables-contact-table"
                                        type="button"><span>
                                ...
                                <div id="botble-contact-tables-contact-table_processing"
                                ...
                                <table
                                    ...
                                    aria-describedby="botble-contact-tables-contact-table_info">
                                    <thead>
                                        <tr>
                                            ...
                                            <th title="Name" class="text-start column-key-1 sorting" tabindex="0"
                                                aria-controls="botble-contact-tables-contact-table" rowspan="1"
                                                colspan="1" aria-label="Nameorderby asc">Name
                                            </th>
                                            <th title="Email" class="text-start column-key-2 sorting" tabindex="0"
                                                aria-controls="botble-contact-tables-contact-table" rowspan="1"
                                                colspan="1" aria-label="Emailorderby asc">Email
                                            </th>
                                            <th title="Phone" class="text-start column-key-3 sorting" tabindex="0"
                                                aria-controls="botble-contact-tables-contact-table" rowspan="1"
                                                colspan="1" aria-label="Phoneorderby asc">Phone
                                            </th>
                                            <th title="Created At" width="100" class="column-key-4 sorting"
                                                tabindex="0" aria-controls="botble-contact-tables-contact-table"
                                    ...
                                    <tbody>
                                        <tr class="odd">
                                            <td valign="top" colspan="8" class="dataTables_empty">No data to
                                                display</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <div class="card-footer d-flex flex-column flex-sm-row justify-content-between align-items-center gap-2"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        <div class="dataTables_length" id="botble-contact-tables-contact-table_length"
                                            style="display: none;"><label><span class="dt-length-style"><select
                                                        name="botble-contact-tables-contact-table_length"
                                                        aria-controls="botble-contact-tables-contact-table"
                                        ...
                                        <div class="m-0 text-muted">
                                            <div class="dataTables_info" id="botble-contact-tables-contact-table_info"
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <div class="dataTables_paginate paging_simple_numbers"
                                            id="botble-contact-tables-contact-table_paginate" style="display: none;">
                                            <ul class="pagination">
                                                <li class="paginate_button page-item previous disabled"
                                                    id="botble-contact-tables-contact-table_previous"><a
                                                        aria-controls="botble-contact-tables-contact-table"
                                                        aria-disabled="true" aria-label="&amp;laquo; Previous"
                                                        role="link" data-dt-idx="previous" tabindex="-1"
                                                        class="page-link">« Previous</a></li>
                                                <li class="paginate_button page-item next disabled"
                                                    id="botble-contact-tables-contact-table_next"><a
                                                        aria-controls="botble-contact-tables-contact-table"
