                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <h1 class="mb-0 d-inline-block fs-6 lh-1">Newsletters</h1>
                                </li>
                            </ol>
                        </nav>
                ...
                <div class="card mb-3 table-configuration-wrap" style="display: none;">
                    <div class="card-body">
                        ...
                        <div class="wrapper-filter">
                            ...
                            <form method="GET" action="/admin/faq-categories" accept-charset="UTF-8"
                                class="filter-form">
                                <input type="hidden" name="filter_table_id" class="filter-data-table-id"
                                    value="botble-faq-tables-faq-category-table">
                                <input type="hidden" name="class" class="filter-data-class"
                                    value="Botble\Faq\Tables\FaqCategoryTable">
                                ...
                                <div class="btn-list">
                                    ...
                                    <a class="btn btn-icon" style="display: none;" type="button"
                                        href="/admin/faq-categories" data-bb-toggle="datatable-reset-filter">
                ...
                <div class="card has-actions has-filter">
                        ...
                        <div class="w-100 gap-2 d-block d-md-flex align-items-start justify-content-between flex-wrap">
                                ...
                                <div class="dropdown d-inline-block mb-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-submenu">
                                            ...
                                            <div class="dropdown-menu">
                                                <button class="dropdown-item bulk-change-item" data-key="name"
                                                    data-class-item="Botble\Faq\Tables\FaqCategoryTable"
                                        ...
                                        <a class="dropdown-item" href="/admin/tables/bulk-actions"
                                            ...
                                            data-table-target="Botble\Faq\Tables\FaqCategoryTable"
                            ...
                            <div class="d-block d-md-flex gap-2 mb-1">
                                <button class="mb-1 btn action-item btn-primary " tabindex="0"
                                    aria-controls="botble-faq-tables-faq-category-table" type="button"
                                    aria-haspopup="dialog" aria-expanded="false">
                                    <span data-action="create" data-href="/admin/faq-categories/create">
                    ...
                    <div class="card-table">
                        <div class="table-responsive table-has-actions table-has-filter">
                            <div id="botble-faq-tables-faq-category-table_wrapper"
                                class="dataTables_wrapper dt-bootstrap5 no-footer">
                                <div id="botble-faq-tables-faq-category-table_filter" class="dataTables_filter">
                                    <label><input type="search" class="form-control form-control-sm"
                                            placeholder="Search..."
                                            aria-controls="botble-faq-tables-faq-category-table"></label>
                                </div>
                                <div class="dt-buttons btn-group w-100 w-sm-auto"> <button
                                        class="btn action-item btn-primary" tabindex="0"
                                        aria-controls="botble-faq-tables-faq-category-table"
                                        type="button"><span><span data-action="create"
                                                data-href="/admin/faq-categories/create">
                                                <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24"
                                        ...
                                        aria-controls="botble-faq-tables-faq-category-table" type="button"><span>
                                ...
                                <div id="botble-faq-tables-faq-category-table_processing"
                                ...
                                <table
                                    ...
                                    id="botble-faq-tables-faq-category-table"
                                    aria-describedby="botble-faq-tables-faq-category-table_info">
                                    <thead>
                                        <tr>
                                            ...
                                            <th title="ID" width="20"
                                                ...
                                                tabindex="0" aria-controls="botble-faq-tables-faq-category-table"
                                            ...
                                            <th title="Name" class="text-start column-key-1 sorting" tabindex="0"
                                                aria-controls="botble-faq-tables-faq-category-table" rowspan="1"
                                    ...
                                    <tbody>
                                        <tr class="odd">
                                            ...
                                            <td class="  text-start  column-key-1"><a
                                                    href="/admin/faq-categories/edit/4" title="Support">Support</a>
                                            </td>
                                            ...
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    <a href="/admin/faq-categories/edit/4">
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="/admin/faq-categories/edit/4?ref_lang=vi"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="/admin/faq-categories/edit/4?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    <a class="btn btn-sm btn-icon btn-primary"
                                                        href="/admin/faq-categories/edit/4">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="/admin/faq-categories/4" data-dt-single-action=""
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                3</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="/admin/faq-categories/edit/3" title="Payment">Payment</a>
                                            </td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            ...
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    <a href="/admin/faq-categories/edit/3">
                                                        <svg class="icon text-success"
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="/admin/faq-categories/edit/3?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="/admin/faq-categories/edit/3?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    <a class="btn btn-sm btn-icon btn-primary"
                                                        href="/admin/faq-categories/edit/3">
                                                        <svg class="icon" data-bs-toggle="tooltip"
                                                            data-bs-title="Edit" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" stroke="currentColor" stroke-width="2"
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="/admin/faq-categories/3" data-dt-single-action=""
                                                        data-method="DELETE" data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                                        data-confirmation-modal-button="Delete"
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                2</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="/admin/faq-categories/edit/2" title="Buying">Buying</a></td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            </td>
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    <a href="/admin/faq-categories/edit/2">
                                                        <svg class="icon text-success"
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="/admin/faq-categories/edit/2?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="/admin/faq-categories/edit/2?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    <a class="btn btn-sm btn-icon btn-primary"
                                                        href="/admin/faq-categories/edit/2">
                                                        <svg class="icon" data-bs-toggle="tooltip"
                                                            data-bs-title="Edit" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" stroke="currentColor" stroke-width="2"
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="/admin/faq-categories/2" data-dt-single-action=""
                                                        data-method="DELETE" data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                                        data-confirmation-modal-button="Delete"
                                        ...
                                        <tr class="even">
                                            ...
                                            <td class="text-center no-column-visibility column-key-0 sorting_1">
                                                1</td>
                                            <td class="  text-start  column-key-1"><a
                                                    href="/admin/faq-categories/edit/1" title="General">General</a>
                                            </td>
                                            <td class="   column-key-2">2024-02-19</td>
                                            <td class="  text-center  column-key-3"><span
                                                    class="badge bg-success text-success-fg">Published</span>
                                            ...
                                            <td class="  text-nowrap language-header text-center">
                                                <div class="text-center language-column">
                                                    <a href="/admin/faq-categories/edit/1">
                                                        <svg class="icon text-success"
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="/admin/faq-categories/edit/1?ref_lang=vi"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                    ...
                                                    <a data-bs-toggle="tooltip"
                                                        href="/admin/faq-categories/edit/1?ref_lang=ar"
                                                        aria-label="Edit related language for this record"
                                                        data-bs-original-title="Edit related language for this record">
                                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            <td class="  text-center no-column-visibility text-nowrap">
                                                <div class="table-actions">
                                                    <a class="btn btn-sm btn-icon btn-primary"
                                                        href="/admin/faq-categories/edit/1">
                                                        <svg class="icon" data-bs-toggle="tooltip"
                                                            data-bs-title="Edit" xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" stroke="currentColor" stroke-width="2"
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger"
                                                        href="/admin/faq-categories/1" data-dt-single-action=""
                                                        data-method="DELETE" data-confirmation-modal="true"
                                                        data-confirmation-modal-title="Confirm delete"
                                                        data-confirmation-modal-message="Do you really want to delete this record?"
                                                        data-confirmation-modal-button="Delete"
                                ...
                                <div class="card-footer d-flex flex-column flex-sm-row justify-content-between align-items-center gap-2"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        <div class="dataTables_length"
                                            id="botble-faq-tables-faq-category-table_length" style="display: none;">
                                            <label><span class="dt-length-style"><select
                                                        name="botble-faq-tables-faq-category-table_length"
                                                        aria-controls="botble-faq-tables-faq-category-table"
                                        ...
                                        <div class="m-0 text-muted">
                                            <div class="dataTables_info"
                                                id="botble-faq-tables-faq-category-table_info" role="status"
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <div class="dataTables_paginate paging_simple_numbers"
                                            id="botble-faq-tables-faq-category-table_paginate" style="display: none;">
                                            <ul class="pagination">
                                                <li class="paginate_button page-item previous disabled"
                                                    id="botble-faq-tables-faq-category-table_previous"><a
                                                        aria-controls="botble-faq-tables-faq-category-table"
                                                ...
                                                <li class="paginate_button page-item next disabled"
                                                    id="botble-faq-tables-faq-category-table_next"><a
                                                        aria-controls="botble-faq-tables-faq-category-table"
