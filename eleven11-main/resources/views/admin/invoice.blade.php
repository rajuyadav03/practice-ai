                    ...
                    <div class="card mb-3 table-configuration-wrap" style="display: none;">
                        <div class="card-body">
                            ...
                            <div class="wrapper-filter">
                                ...
                                <form method="GET" action="admin/real-estate/invoices" accept-charset="UTF-8"
                                    class="filter-form">
                                    <input type="hidden" name="filter_table_id" class="filter-data-table-id"
                                        value="botble-real-estate-tables-invoice-table">
                                    <input type="hidden" name="class" class="filter-data-class"
                                        value="Botble\RealEstate\Tables\InvoiceTable">
                                    ...
                                    <div class="btn-list">
                                        ...
                                        <a class="btn btn-icon" style="display: none;" type="button"
                                            href="admin/real-estate/invoices" data-bb-toggle="datatable-reset-filter">
                    ...
                    <div class="card has-actions has-filter">
                        <div class="card-table">
                            <div class="table-responsive table-has-actions table-has-filter">
                                <div id="botble-real-estate-tables-invoice-table_wrapper"
                                    class="dataTables_wrapper dt-bootstrap5 no-footer">
                                    <div id="botble-real-estate-tables-invoice-table_processing"
                                    ...
                                    <table
                                        ...
                                        id="botble-real-estate-tables-invoice-table"
                                        aria-describedby="botble-real-estate-tables-invoice-table_info">
                                        <thead>
                                            <tr>
                                                ...
                                                <th title="ID" width="20"
                                                    ...
                                                    tabindex="0" aria-controls="botble-real-estate-tables-invoice-table"
                                                    rowspan="1" colspan="1" style="width: 20px;"
                                                    aria-sort="descending" aria-label="IDorderby asc">ID</th>
                                                <th title="Account" class="text-start column-key-1 sorting"
                                                    tabindex="0" aria-controls="botble-real-estate-tables-invoice-table"
                                                    rowspan="1" colspan="1" aria-label="Accountorderby asc">
                                                    Account</th>
                                                <th title="Code" class="text-start column-key-2 sorting" tabindex="0"
                                                    aria-controls="botble-real-estate-tables-invoice-table" rowspan="1"
                                                    colspan="1" aria-label="Codeorderby asc">Code
                                                </th>
                                    ...
                                    <div class="card-footer d-flex flex-column flex-sm-row justify-content-between align-items-center gap-2"
                                        ...
                                        <div class="d-flex justify-content-between align-items-center gap-3">
                                            <div class="dataTables_length"
                                                id="botble-real-estate-tables-invoice-table_length"
                                                style="display: none;"><label><span class="dt-length-style"><select
                                                            name="botble-real-estate-tables-invoice-table_length"
                                                            aria-controls="botble-real-estate-tables-invoice-table"
                                            ...
                                            <div class="m-0 text-muted">
                                                <div class="dataTables_info"
                                                    id="botble-real-estate-tables-invoice-table_info" role="status"
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <div class="dataTables_paginate paging_simple_numbers"
                                                id="botble-real-estate-tables-invoice-table_paginate"
                                                style="display: none;">
                                                <ul class="pagination">
                                                    <li class="paginate_button page-item previous disabled"
                                                        id="botble-real-estate-tables-invoice-table_previous"><a
                                                            aria-controls="botble-real-estate-tables-invoice-table"
                                                            aria-disabled="true" aria-label="&amp;laquo; Previous"
                                                            role="link" data-dt-idx="previous" tabindex="-1"
                                                            class="page-link">« Previous</a></li>
                                                    <li class="paginate_button page-item next disabled"
                                                        id="botble-real-estate-tables-invoice-table_next"><a
                                                            aria-controls="botble-real-estate-tables-invoice-table"
